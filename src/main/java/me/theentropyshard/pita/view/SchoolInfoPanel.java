...
public class SchoolInfoPanel extends JPanel {
    ...
    public SchoolInfoPanel() {
        ...
        panel.add(new JPanel() {{
            ...
            this.add(new GradientLabel("Основная информация", PitaColors.DARK_COLOR, PitaColors.LIGHT_COLOR) {{
        ...
        panel.add(new JPanel() {{
            this.setBackground(Color.WHITE);
            this.add(new GradientLabel("Управление", PitaColors.DARK_COLOR, PitaColors.LIGHT_COLOR) {{
                this.setFont(new Font("JetBrains Mono", Font.BOLD, 18));
            }});
        }});
        ...
        panel.add(new JPanel() {{
            this.setBackground(Color.WHITE);
            this.add(new GradientLabel("Контактная информация", PitaColors.DARK_COLOR, PitaColors.LIGHT_COLOR) {{
                this.setFont(new Font("JetBrains Mono", Font.BOLD, 18));
            }});
        }});
        ...
        panel.add(new JPanel() {{
            this.setBackground(Color.WHITE);
            this.add(new GradientLabel("Другая информация", PitaColors.DARK_COLOR, PitaColors.LIGHT_COLOR) {{
                this.setFont(new Font("JetBrains Mono", Font.BOLD, 18));
            }});
        }});
        ...
        panel.add(new JPanel() {{
            this.setBackground(Color.WHITE);
            this.add(new GradientLabel("Оплата питания", PitaColors.DARK_COLOR, PitaColors.LIGHT_COLOR) {{
                this.setFont(new Font("JetBrains Mono", Font.BOLD, 18));
            }});
        }});
        ...
        panel.add(new JPanel() {{
            this.setBackground(Color.WHITE);
            this.add(new GradientLabel("Информация об интернет-соединении", PitaColors.DARK_COLOR, PitaColors.LIGHT_COLOR) {{
                this.setFont(new Font("JetBrains Mono", Font.BOLD, 18));
            }});
        }});
    }
